...
(
  ...
  `link`        VARCHAR(70)     NOT NULL    UNIQUE,
...
('HTML of MDN',             'developer.mozilla.org/en-US/docs/Web/HTML/Element',    'HTML',         'Specifications',               'This page lists all the HTML elements, which are created using tags. They are grouped by function to help you find what you have in mind easily. An alphabetical list of all elements is provided in the sidebar on every element page as well as this one.'),
...
('JavaScript of MDN',       'developer.mozilla.org/en-US/docs/Web/JavaScript',      'JavaScript',   'Specifications',               'JavaScript is a lightweight, interpreted, or just-in-time compiled programming language with first-class functions. While it is most well-known as the scripting language for Web pages, many non-browser environments also use it, such as Node.js. JavaScript is a prototype-based, multi-paradigm, single-threaded, dynamic language, supporting object-oriented, imperative & declarative styles.'),
('Node.js',                 'nodejs.org/en',                                        'JavaScript',   'Specifications',               'Node.js is a JavaScript runtime built on Chrome V8 JavaScript engine.'),
...
('Angular',                 'angular.io',                                           'JavaScript',   'Framework Frontend',           'Angular is a platform for building mobile & desktop web applications. Join the community of millions of developers who build compelling user interfaces with Angular.'),
('React',                   'reactjs.org',                                          'JavaScript',   'Framework Frontend',           'A JavaScript library for building user interfaces.'),
('Vue.js',                  'vuejs.org',                                            'JavaScript',   'Framework Frontend',           'Vue.js - The Progressive JavaScript Framework'),
('Express',                 'expressjs.com',                                        'JavaScript',   'Framework Backend',            'Fast, unopinionated, minimalist web framework for Node.js'),
('Electron',                'www.electronjs.org',                                   'JavaScript',   'Framework Desktop',            'Build cross-platform desktop apps with JavaScript, HTML, & CSS'),
('Cordova',                 'cordova.apache.org',                                   'JavaScript',   'Framework Mobile',             'Mobile apps with HTML, CSS & JS. Target multiple platforms with one code base. Free & open source'),
('Ionic',                   'ionicframework.com',                                   'JavaScript',   'Framework Mobile',             'Ionic is the app development platform for web developers. Build amazing cross platform mobile, web, & desktop apps all with one shared code base & open web standards'),
('Weex',                    'weex.apache.org',                                      'JavaScript',   'Framework Mobile',             'Weex is a framework for building performant mobile apps with modern web technology.'),
('React Native',            'reactnative.dev',                                      'JavaScript',   'Framework Mobile',             'Create native apps for Android & iOS using React. React Native combines the best parts of native development with React, a best-in-class JavaScript library for building user interfaces.'),
('Vue Native',              'vue-native.io',                                        'JavaScript',   'Framework Mobile',             'Vue Native is a framework to build cross platform native mobile apps using JavaScript'),
