...
('Font Awesome',            'fontawesome.com',                                  'CSS',    'Librairie d’icônes',     'Obtenez des icônes vectorielles & des logos sociaux sur votre site Web avec Font Awesome, le jeu d’icônes & la boîte à outils les plus populaires du Web.'),
('Google Fonts',            'fonts.google.com',                                 'CSS',    'Typographie',            'Rendre le Web plus beau, plus rapide et plus ouvert grâce à une excellente typographie'),
('Online Web Fonts',        'www.onlinewebfonts.com',                           'CSS',    'Typographie',            'Online Web Fonts est un site Web de téléchargement de polices en ligne. Il propose plus de 8 240 170 polices de bureau et Web que vous pouvez prévisualiser et télécharger.'),
('Font Squirrel',           'www.fontsquirrel.com',                             'CSS',    'Typographie',            'Font Squirrel parcourt Internet à la recherche de polices de haute qualité légitimement gratuites. Téléchargez des milliers de polices entièrement légales, de haute qualité et gratuites.'),
...
('Git Officiel',            'git-scm.com',                                      'Git',    'Spécifications',         'Git est un système de contrôle de version distribué gratuit & open source conçu pour gérer tout, des petits projets aux très grands projets avec rapidité & efficacité.'),
('Git Doc',                 'git-scm.com/doc',                                  'Git',    'Documentation',          'The official and comprehensive man pages that are included in the Git package itself.'),
('GitHub',                  'github.com',                                       'Git',    'Dépot de Code',          'GitHub est l’endroit où les gens créent des logiciels. Plus de 56 millions de personnes utilisent GitHub pour découvrir & contribuer à plus de 100 millions de projets.'),
('GitHub Doc',              'docs.github.com/en/github',                        'Git',    'Dépot de Code',          'Couvre l’utilisation de Git, les pull requests, les problèmes, les wikis, les informations essentielles & tout ce dont vous avez besoin pour tirer le meilleur parti de GitHub pour le développement.'),
('GitKraken',               'www.gitkraken.com',                                'Git',    'Client Git',             'GitKraken, l’interface graphique gratuite de Git pour Windows, Mac & Linux! Cette interface graphique intuitive Git simplifie & rationalise les processus Git.'),
('Badgen',                  'badgen.net',                                       'Git',    'Badges',                 'Service de génération rapide de badges.'),
('Shields IO',              'shields.io',                                       'Git',    'Badges',                 'Nous servons des images d’information rapides et évolutives comme badges pour GitHub, Travis CI, Jenkins, WordPress, etc. Utilisez-les pour suivre l’état de vos projets ou à des fins promotionnelles.'),
('For The Badge',           'forthebadge.com',                                  'Git',    'Badges',                 'Des badges pour l’amour des badges.'),
('Pixabay',                 'pixabay.com',                                      'Media',  'Banque d’images',        'Superbes images gratuites & stock libres de droits. Plus de 1,9 million d’images, de vidéos & de musique de haute qualité partagés par notre communauté talentueuse.'),
('Unsplash',                'unsplash.com',                                     'Media',  'Banque d’images',        'La source Internet d’images librement utilisables. Propulsé par des créateurs partout.'),
('NegativeSpace',           'negativespace.co',                                 'Media',  'Banque d’images',        'Belles photos libres de droits en haute résolution. Pour un usage personnel ou commercial, toutes nos images sous licence CC0 sont totalement gratuites!'),
('FreePik',                 'fr.freepik.com',                                   'Media',  'Banque d’images',        'Ressources graphiques pour tout le monde. Trouvez des Vecteurs, Photos de Stock & PSD Gratuites'),
('ThisPersonDoesNotExist',  'thispersondoesnotexist.com',                       'Media',  'Générateur de Visages',  'Génération de visages humains par une Intelligence Artificielle.'),
('FlatIcon',                'www.flaticon.com',                                 'Media',  'Banque d’icônes',        'Accédez à 4 141 000 icônes vectorielles. La plus grande base de données d’icônes gratuites disponible aux formats PNG, SVG, EPS, PSD et BASE 64.'),
('IconNinja',               'www.iconninja.com',                                'Media',  'Banque d’icônes',        'Icon Ninja rassemble 700081 icônes gratuites dans 16306 jeux d’icônes, y compris 33350 icônes vectorielles et 666731 icônes png fond transparent, vous pouvez également générer des sprites icône css en ligne'),
('ShareIcon',               'www.shareicon.net',                                'Media',  'Banque d’icônes',        'Trouver et télécharger des icônes png, svg, ico, psd, ai, icns pour les sites Web'),
('Noun Project',            'thenounproject.com',                               'Media',  'Banque d’icônes',        'Icônes et photos pour tout. Noun Project construit un langage visuel global qui nous unit.');