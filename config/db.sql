...
('HTML Validator',          'validator.w3.org',                                 'HTML',   'Validateur',             'Ce validateur vérifie la validité du balisage des documents Web en HTML, XHTML, SMIL, MathML, etc.'),
...
('Markdown to HTML',        'markdowntohtml.com',                               'HTML',   'Convertisseur',          'Collez ou tapez votre markdown & voyez-le rendu au format HTML. Téléchargez ou copiez le code HTML résultant.'),
...
('XML Sitemaps',            'www.xml-sitemaps.com',                             'HTML',   'Générateur de Sitemap',  'Gratuit & simple. Convient lorsque vous avez besoin de créer rapidement un plan du site pour un petit site Web (jusqu’à 500) pages.'),
...
('CSS Validator',           'jigsaw.w3.org/css-validator',                      'CSS',    'Validateur',             'Vérifiez vos feuilles de style CSS & vos documents HTML stylés avec CSS'),
('CSS Tricks',              'css-tricks.com',                                   'CSS',    'Tutoriels',              'Articles quotidiens sur CSS, HTML, JavaScript & tout ce qui concerne la conception & le développement Web.'),
...
('Google Fonts',            'fonts.google.com',                                 'CSS',    'Typographie',            'Rendre le Web plus beau, plus rapide & plus ouvert grâce à une excellente typographie'),
('Online Web Fonts',        'www.onlinewebfonts.com',                           'CSS',    'Typographie',            'Online Web Fonts est un site Web de téléchargement de polices en ligne. Il propose plus de 8 240 170 polices de bureau & Web que vous pouvez prévisualiser & télécharger.'),
('Font Squirrel',           'www.fontsquirrel.com',                             'CSS',    'Typographie',            'Font Squirrel parcourt Internet à la recherche de polices de haute qualité légitimement gratuites. Téléchargez des milliers de polices entièrement légales, de haute qualité & gratuites.'),
...
('Yarn',                    'classic.yarnpkg.com/fr',                           'JS',     'Package Manager',        'Yarn est un gestionnaire de packages qui se double de chef de projet. Que vous travailliez sur des projets ponctuels ou de grands monorepos, en tant qu’amateur ou utilisateur d’entreprise, nous sommes là pour vous.'),
...
('PSR',                     'www.php-fig.org/psr',                              'PHP',    'Standard',               'PHP Standards Recommandations est un groupe de projets PHP établis dont le but est de parler des points communs entre ces projets & de trouver des moyens de mieux travailler ensemble.'),
('XAMPP',                   'www.apachefriends.org/fr/index.html',              'PHP',    'Environnement',          'XAMPP est une distribution Apache entièrement gratuite & facile à installer contenant MySQL, PHP & Perl. Le paquetage open source XAMPP a été mis au point pour être incroyablement facile à installer & à utiliser.'),
...
('AFSY',                    'afsy.fr',                                          'PHP',    'Tutoriels',              'Association Francophone des Utilisateurs de Symfony. Groupe de professionnels du Web passionnés par le framework PHP Symfony.'),
...
('Shields IO',              'shields.io',                                       'Git',    'Badges',                 'Nous servons des images d’information rapides & évolutives comme badges pour GitHub, Travis CI, Jenkins, WordPress, etc. Utilisez-les pour suivre l’état de vos projets ou à des fins promotionnelles.'),
('For The Badge',           'forthebadge.com',                                  'Git',    'Badges',                 'Des badges pour l’amour des badges.'),
('Dependabot',              'dependabot.com',                                   'Git',    'Dépendances',            'Mises à jour automatisées des dépendances. Dependabot crée des pull requests pour garder vos dépendances sécurisées & à jour.'),
('Codacy',                  'www.codacy.com',                                   'Git',    'Qualité du Code',        'Le moyen le plus simple de s’assurer que votre équipe écrit du code de haute qualité. C’est un outil d’analyse statique conçu pour analyser plus de 30 langages.'),
('Code Climate',            'codeclimate.com',                                  'Git',    'Maintenabilité du Code', 'Velocity transforme les données des validations & des demandes d’extraction en informations dont vous avez besoin pour améliorer durablement la productivité de votre équipe.'),
...
('TinyPNG',                 'tinypng.com',                                      'Media',  'Compression d’Images',   'Compression intelligente PNG & JPEG. Plus d’un milliard d’images PNG & JPEG optimisées & toujours comptées!'),
('Squoosh',                 'squoosh.app',                                      'Media',  'Compression d’Images',   'Compressez & comparez des images avec différents codecs, directement dans votre navigateur'),
...
('FlatIcon',                'www.flaticon.com',                                 'Media',  'Banque d’Icônes',        'Accédez à 4 141 000 icônes vectorielles. La plus grande base de données d’icônes gratuites disponible aux formats PNG, SVG, EPS, PSD & BASE 64.'),
('IconNinja',               'www.iconninja.com',                                'Media',  'Banque d’Icônes',        'Icon Ninja rassemble 700081 icônes gratuites dans 16306 jeux d’icônes, y compris 33350 icônes vectorielles & 666731 icônes png fond transparent, vous pouvez également générer des sprites icône css en ligne'),
('ShareIcon',               'www.shareicon.net',                                'Media',  'Banque d’Icônes',        'Trouver & télécharger des icônes png, svg, ico, psd, ai, icns pour les sites Web'),
('Noun Project',            'thenounproject.com',                               'Media',  'Banque d’Icônes',        'Icônes & photos pour tout. Noun Project construit un langage visuel global qui nous unit.'),
('Small PDF',               'smallpdf.com',                                     'Media',  'Compression de PDF',     'Nous simplifions le PDF. Tous les outils dont vous aurez besoin pour être plus productif & travailler plus intelligemment avec des documents.'),
('PDF Zorro',               'www.pdfzorro.com',                                 'Media',  'Editeur de PDF',         'Parfait PDF-Online-Editor pour éditer des fichiers PDF en ligne dans le navigateur - gratuitement'),
('Sejda',                   'www.sejda.com/fr',                                 'Media',  'Editeur de PDF',         'Nous vous aidons avec vos tâches PDF. Éditeur PDF facile, plaisant & productif');
