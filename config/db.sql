...
('Git Officiel',    'git-scm.com',                                      'Git',    'Spécifications',         'Git est un système de contrôle de version distribué gratuit et open source conçu pour gérer tout, des petits projets aux très grands projets avec rapidité et efficacité.'),
...
('GitHub',          'github.com',                                       'Git',    'Dépot de Code',          'GitHub est l’endroit où les gens créent des logiciels. Plus de 56 millions de personnes utilisent GitHub pour découvrir et contribuer à plus de 100 millions de projets.'),
('GitHub Doc',      'docs.github.com/en/github',                        'Git',    'Dépot de Code',          'Couvre l’utilisation de Git, les pull requests, les problèmes, les wikis, les informations essentielles et tout ce dont vous avez besoin pour tirer le meilleur parti de GitHub pour le développement.'),
('GitKraken',       'www.gitkraken.com',                                'Git',    'Client Git',             'GitKraken, l’interface graphique gratuite de Git pour Windows, Mac et Linux! Cette interface graphique intuitive Git simplifie et rationalise les processus Git.'),
('Pixabay',         'pixabay.com',                                      'Media',  'Banque d’images',        'Superbes images gratuites et stock libres de droits. Plus de 1,9 million d’images, de vidéos et de musique de haute qualité partagés par notre communauté talentueuse.'),
...
('FreePik',         'fr.freepik.com',                                   'Media',  'Banque d’images',        'Ressources graphiques pour tout le monde. Trouvez des Vecteurs, Photos de Stock et PSD Gratuites'),
('ThisPersDoesNot', 'thispersondoesnotexist.com',                       'Media',  'Générateur de Visages',  'Génération de visages humains par une Intelligence Artificielle.');
